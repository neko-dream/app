        ...
        >
          ...
          >
            ...
            <animated.div
              ...
              className="absolute w-full h-full z-10 rounded"
            >
              <p className="absolute text-white font-bold text-3xl right-4 top-4">
                違うかも
              </p>
            </animated.div>
            <animated.div
              ...
              className="absolute w-full h-full z-10 rounded"
            >
              <p className="text-white font-bold text-3xl p-4">いいかも</p>
            </animated.div>
            <Card
