...
export const OpinionModal = ({ open, onOpenChange, ...props }: Props) => {
  ...
  return (
    <>
      <animated.div
        style={item}
        className="absolute bottom-0 z-30 h-[80%] w-[375px] touch-none rounded-t-xl border-t border-gray-200 bg-white will-change-transform"
      >
        <Form
          {...props}
          {...getFormProps(form)}
      ...
      <animated.div
        ...
        // FIXME: -mt-8 直したい
        className="absolute top-0 z-10 -mt-8 h-full w-[375px] bg-slate-600/60"
